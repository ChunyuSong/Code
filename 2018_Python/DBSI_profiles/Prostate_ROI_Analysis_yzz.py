...
def main():
    data_folder = '/bmrp092temp/prostate_Cancer_Project_Shanghai/ALL_DBSI_DATA_new_thresh_all/Non_PCa_with_biopsy/1_BIAN_ZHENG_XIANG/'
    ...
    for dir in dirs:
        ...
        if type == 'Non_PCa_with_biopsy' or type == 'Non_PCa_without_biopsy':
            ...
            roi_path = os.path.dirname(os.path.dirname(dir)).replace('ALL_DBSI_DATA_new_thresh_all','All_ROI')
