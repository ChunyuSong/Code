...
d1st_isotropic_diff = cRawData.DBSI_iIsoSpecGrid(d1st_isotropic_grid)*cRawData.DBSI_aIsoSpecdata(d1st_isotropic_grid,:)./sum(cRawData.DBSI_aIsoSpecdata(d1st_isotropic_grid,:),1)*1000.0;
d2nd_isotropic_diff = cRawData.DBSI_iIsoSpecGrid(d2nd_isotropic_grid)*cRawData.DBSI_aIsoSpecdata(d2nd_isotropic_grid,:)./sum(cRawData.DBSI_aIsoSpecdata(d2nd_isotropic_grid,:),1)*1000.0;
d3rd_isotropic_diff = cRawData.DBSI_iIsoSpecGrid(d3rd_isotropic_grid)*cRawData.DBSI_aIsoSpecdata(d3rd_isotropic_grid,:)./sum(cRawData.DBSI_aIsoSpecdata(d3rd_isotropic_grid,:),1)*1000.0;
d4th_isotropic_diff = cRawData.DBSI_iIsoSpecGrid(d4th_isotropic_grid)*cRawData.DBSI_aIsoSpecdata(d4th_isotropic_grid,:)./sum(cRawData.DBSI_aIsoSpecdata(d4th_isotropic_grid,:),1)*1000.0;
...
iso_adc_map = zeros(map_dimensions);
iso_adc_map(roi_index) = isotropic_diff;
