...
if __name__ == '__main__':
    ...
    result_dir  = r'\\10.39.42.102\temp\Zezhong_Ye\Prostate_Cancer_ex_vivo\Deep_Learning'
    log_dir     = r'\\10.39.42.102\temp\Zezhong_Ye\Prostate_Cancer_ex_vivo\Deep_Learning\log'
    pred_dir    = r'\\10.39.42.102\temp\Zezhong_Ye\PCa_prediction\WU_001_C9'
             
    train_file     = 'PCa.csv'
    pred_file      = 'PCa.csv'
    overlaid_map   = 'b0_map.nii'
    DBSI_folder    = 'DBSI_results_0.1_0.1_0.8_0.8_1.5_1.5'
    prediction_map = 'prediction' + '_' + str(learning_rate) + '_' + str(batch_momentum) + '_'+ str(dropout_rate) + '.nii'
