...
if __name__ == '__main__':
    ...
    result_dir  = r'\\10.39.42.102\temp\Zezhong_Ye\Prostate_Cancer_ex_vivo\Deep_Learning\PCa_Benign\result'
    log_dir     = r'\\10.39.42.102\temp\Zezhong_Ye\Prostate_Cancer_ex_vivo\Deep_Learning\PCa_Benign\log'             
    train_file  = 'PCa.csv'
