...
if __name__ == '__main__':
    ...
    result_dir  = r'\\10.39.42.102\temp\Prostate_Cancer_ex_vivo\Deep_Learning\ROC_temp\result'
    log_dir     = r'\\10.39.42.102\temp\Prostate_Cancer_ex_vivo\Deep_Learning\ROC_temp\log'             
    train_file  = 'PCa.csv'
    ...
    total_run = len(list_LR)*len(list_BM)*len(list_EP)*len(list_BS)*len(list_NN)*len(list_DR)
