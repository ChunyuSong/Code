...
df_3.loc[df_3['ROI_Class'] == 't', 'y_cat'] = 0
df_3.loc[df_3['ROI_Class'] == 'c', 'y_cat'] = 1
# df_3.loc[df_3['ROI_Class'] == 'c', 'y_cat'] = 1

class0 = df_3[df_3['y_cat'] == 0]
class0_sample = class0.sample(int(class0.shape[0]))

class1 = df_3[df_3['y_cat'] == 1]
...
df_7.loc[df_7['ROI_Class'] == 't', 'y_cat'] = 0
df_7.loc[df_7['ROI_Class'] == 'c', 'y_cat'] = 1
# df_6.loc[df_6['ROI_Class'] == 'c', 'y_cat'] = 1

class0 = df_7[df_7['y_cat'] == 0]
class0_sample = class0.sample(int(class0.shape[0]))

class1 = df_7[df_7['y_cat'] == 1]
class1_sample = class1.sample(int(class1.shape[0]*0.647))
