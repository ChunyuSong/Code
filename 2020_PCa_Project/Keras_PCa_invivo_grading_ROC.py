...
def data_loading():
    ...
    x = df.iloc[:, [1, 2, 3, 8, 11, 13, 14, 18, 19, 20, 22, 26,
...
##         linewidth=3
##)
colors = cycle(['black', 'aqua', 'red', 'purple', 'royalblue'])
