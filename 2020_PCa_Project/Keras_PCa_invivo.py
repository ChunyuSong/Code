...
df_7.loc[df_7['ROI_Class'] == 'p', 'y_cat'] = 0
...
print("class0 train size:", class0_train.shape[0])
print("class1 train size:", class1_train.shape[0])
print("class0 test size:", class0_test.shape[0])
print("class1 test size:", class1_test.shape[0])
