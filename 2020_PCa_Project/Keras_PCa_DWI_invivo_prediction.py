...
class data(object):
    ...
    def data_balancing(self):
        ...
        #df.loc[df['ROI_Name'] == 'p', 'y_cat'] = 0
        #df.loc[df['ROI_Name'] == 'c', 'y_cat'] = 0     
    ...
    def data_prediction(self):
        ...
        x_pred = df_pred.iloc[:, self.x_input]
...
def prediction():
    ...
    x_index = np.asarray(df_pred.iloc[:, [3]])[:,0]
    y_index = np.asarray(df_pred.iloc[:, [4]])[:,0]
    z_index = np.asarray(df_pred.iloc[:, [5]])[:,0]
...
if __name__ == '__main__':
    ...
    project_dir = r'\\10.39.42.102\temp\Zezhong_Ye\Prostate_Cancer_Project_Shanghai\PCa_Deep_Learning'
    result_dir  = r'\\10.39.42.102\temp\Zezhong_Ye\Prostate_Cancer_Project_Shanghai\PCa_Deep_Learning'
    log_dir     = r'\\10.39.42.102\temp\Zezhong_Ye\Prostate_Cancer_Project_Shanghai\PCa_Deep_Learning\log'
    pred_dir    = r'\\10.39.42.102\temp\Zezhong_Ye\PCa_prediction\case_1_DWI'
           
    file           = 'PCa_DWI.csv'
    pred_file      = 'PCa.csv'
    DBSI_folder    = 'DBSI_results_0.1_0.1_0.8_0.8_2.3_2.3'
    overlaid_map   = 'b0_map.nii'
    prediction_map = 'prediction_map.nii'
